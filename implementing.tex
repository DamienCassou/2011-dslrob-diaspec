...
implementation of the \ct{Movement} context operator. The
\ct{onObstacleDetection} method is declared abstract in the
\ct{AbstractMovement} super class.
...
\ct{NodeMain} interface. An abstract of the deployment script for the

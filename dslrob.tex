...
{morekeywords={entity, attribute, extends, source, action, controller,
    context, from, on, void, Integer, Boolean, String, enumeration,
    structure, indexed, by, as, include, when, get, no, maybe, always,
    publish, behavior, required, provided, abstract, do, any},%
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
}
